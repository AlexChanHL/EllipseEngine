...
namespace Ellipse {
 ...
 class RendererImpl final : public Renderer {
    public:
     ...
     virtual Pair<int, int> getWindowFrameSize() override { return Pair<int, int>{m_currentWidth, m_currentHeight}; }
     virtual SharedPtr<RenderObj> createRenderObj(RenderObjData modelData) override;
     virtual SharedPtr<RenderShaderObj> createShaderObj(String vShader, String fShader) override;
     virtual UniquePtr<RenderPlugin>& plugin() override { return m_plugin; }
